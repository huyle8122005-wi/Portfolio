export const ContactButton = ({ className = "", label = "Liên hệ" }: { className?: string; label?: string }) => (
  <button 
...
export const LiveProjectButton = ({ className = "", label = "Xem dự án" }: { className?: string; label?: string }) => (
